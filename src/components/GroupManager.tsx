...
export default function GroupManager({ selectedGroup, onGroupChange }: GroupManagerProps) {
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-4">
      ...
      {showNewGroup && (
        <div className="mb-4 p-3 bg-gray-50 dark:bg-gray-700 rounded-xl space-y-3">
          <input
            type="text"
            value={newGroupName}
            onChange={(e) => setNewGroupName(e.target.value)}
            placeholder="Group name..."
            className="w-full px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:border-blue-500 dark:focus:border-blue-400"
          />
          ...
          <button
            ...
            className="w-full py-1.5 text-xs bg-blue-600 dark:bg-blue-600 text-white rounded-lg hover:bg-blue-700 dark:hover:bg-blue-500 disabled:opacity-50"
          >
            Create Group
          </button>
        </div>
